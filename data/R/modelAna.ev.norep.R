...
save('data', file = 'read.data.norep.Rdata')
load(file = 'read.data.norep.Rdata')
...
models = list(
  'all' = list(
    'params' = function(){list(p.target = rnorm(1, -1, 1+attempt/100),
                               ...
                               #p.rep=rnorm(1, -1, 1+attempt/100),
                               
    )},
    'fixed' = list(p.rep=-100, norep=1)),
  'nowhole' = list(
    'params' = function(){list(p.target = rnorm(1, -1, 1+attempt/100),
                               p.part=rnorm(1, -1, 1+attempt/100),
                               p.color=rnorm(1, -1, 1+attempt/100),
    ...
    'fixed' = list(p.rep=-100, norep=1,p.whole = -100)),
  'nopart' = list(
    'params' = function(){list(p.target = rnorm(1, -1, 1+attempt/100),
                               p.whole = rnorm(1, -1, 1+attempt/100),
                               p.color=rnorm(1, -1, 1+attempt/100),
    ...
    'fixed' = list(p.rep=-100, norep=1,p.part = -100)),
  'nowholepart' = list(
    'params' = function(){list(p.target = rnorm(1, -1, 1+attempt/100),
                               p.color=rnorm(1, -1, 1+attempt/100),
                               scale=rnorm(1, 0, 1+attempt/100) #,
    ...
    'fixed' = list(p.rep=-100, norep=1,p.whole = -100, p.part=-100))
)
...
save('data', 'fits', 'failures', file = 'fits.norep.Rdata')
