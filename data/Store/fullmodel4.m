function resid=fullmodel4(params,data)
% v3-Original model
...
if (p_colorA+p_colorB)<=1 && sum(params<0)==0 && (sum(params([1:3 end]))<=1)
    ...
    Apart_Acolor_matrix(Aopt,Aopt)=Apart_Acolor_matrix(Aopt,Aopt)+Apart_Acolor_matrix(Aopt,Aopt)*diagSum;
    ...
    Acolor_Acolor_matrix(Aopt,Aopt)=Acolor_Acolor_matrix(Aopt,Aopt)+Acolor_Acolor_matrix(Aopt,Aopt)*diagSum;
    ...
    Bcolor_Bpart_matrix(Bopt,Bopt)=Bcolor_Bpart_matrix(Bopt,Bopt)+Bcolor_Bpart_matrix(Bopt,Bopt)*diagSum;
    ...
    Bcolor_Bcolor_matrix(Bopt,Bopt)=Bcolor_Bcolor_matrix(Bopt,Bopt)+Bcolor_Bcolor_matrix(Bopt,Bopt)*diagSum;
