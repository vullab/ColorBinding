...
%             end
            ...
            % Sample subjects
            currCount3=sum(colReport2{ci}(:,:,randsample(size(colReport2{ci},3),size(colReport2{ci},3),true)),3);
            
            quickie = @(params,currCount3)(fullmodel5(params,currCount3));
            fx = @(params)(quickie(params,currCount3));
...
%     [mllk mcounts]=fullmodel5v2(params(ci,:),currCount);
%     modllk(:,:,ci)=mllk;
%     modcounts(:,:,ci)=mcounts;
%     subplot(2,2,ci)
...
for i=1:length(stimtype)
    ...
    image((mean(params(i,2,:),3)+shift)*scale,(mean(params(i,1,:),3)+shift)*scale,(im2))
end
plot(mean(params(:,2,:),3)*scale,mean(params(:,1,:),3)*scale,'k.')

low=mean(params(:,1,:),3)-prctile(params(:,1,:),2.5,3);
high=prctile(params(:,1,:),97.5,3)-mean(params(:,1,:),3);
errorbar(mean(params(:,2,:),3)*scale,mean(params(:,1,:),3)*scale,low*scale,high*scale,'k.')

low=mean(params(:,2,:),3)-prctile(params(:,2,:),2.5,3);
high=prctile(params(:,2,:),97.5,3)-mean(params(:,2,:),3);
herrorbar(mean(params(:,2,:),3)*scale,mean(params(:,1,:),3)*scale,low*scale,high*scale,'k.')
...
set(gca,'Xtick',linspace(max([min([mean(params(:,2,:),3)-shift*4]) 0])*scale,max(mean(params(:,2,:),3)+shift*4)*scale,3),'XTickLabel',{num2str(max([min([mean(params(:,2,:),3)-shift*4]) 0]),2),num2str(max(mean(params(:,2,:),3)+shift*4)/2,2),num2str(max(mean(params(:,2,:),3)+shift*4),2)})
set(gca,'Ytick',linspace(max([min([mean(params(:,1,:),3)-shift*4]) 0])*scale,max(mean(params(:,1,:),3)+shift*4)*scale,3),'YTickLabel',{num2str(max([min([mean(params(:,1,:),3)-shift*4]) 0]),2),num2str(max(mean(params(:,1,:),3)+shift*4)/2,2),num2str(max(mean(params(:,1,:),3)+shift*4),2)})
xlabel('P-Part')
ylabel('P-Whole')
hold off
...
errorbar(mean(params(:,2,:),3)*scale,mean(params(:,3,:),3)*scale,low*scale,high*scale,'k.')

low=mean(params(:,2,:),3)-prctile(params(:,2,:),2.5,3);
high=prctile(params(:,2,:),97.5,3)-mean(params(:,2,:),3);
herrorbar(mean(params(:,2,:),3)*scale,mean(params(:,3,:),3)*scale,low*scale,high*scale,'k.')
%xlim([max([min([params(:,2)-shift*4]) 0])*scale max(params(:,2)+shift*4)*scale])
...
low=mean(params(:,1,:),3)-prctile(params(:,1,:),2.5,3);
high=prctile(params(:,1,:),97.5,3)-mean(params(:,1,:),3);
errorbar(mean(params(:,3,:),3)*scale,mean(params(:,1,:),3)*scale,low*scale,high*scale,'k.')

low=mean(params(:,3,:),3)-prctile(params(:,3,:),2.5,3);
high=prctile(params(:,3,:),97.5,3)-mean(params(:,3,:),3);
herrorbar(mean(params(:,3,:),3)*scale,mean(params(:,1,:),3)*scale,low*scale,high*scale,'k.')
...
errorbar(mean(params(:,1,:),3)*scale,mean(params(:,7,:),3)*scale,low*scale,high*scale,'k.')

low=mean(params(:,1,:),3)-prctile(params(:,1,:),2.5,3);
high=prctile(params(:,1,:),97.5,3)-mean(params(:,1,:),3);
herrorbar(mean(params(:,1,:),3)*scale,mean(params(:,7,:),3)*scale,low*scale,high*scale,'k.')
...
low=mean(params(:,7,:),3)-prctile(params(:,7,:),2.5,3);
high=prctile(params(:,7,:),97.5,3)-mean(params(:,7,:),3);
errorbar(mean(params(:,2,:),3)*scale,mean(params(:,7,:),3)*scale,low*scale,high*scale,'k.')

low=mean(params(:,2,:),3)-prctile(params(:,2,:),2.5,3);
high=prctile(params(:,2,:),97.5,3)-mean(params(:,2,:),3);
herrorbar(mean(params(:,2,:),3)*scale,mean(params(:,7,:),3)*scale,low*scale,high*scale,'k.')
...
low=mean(params(:,7,:),3)-prctile(params(:,7,:),2.5,3);
high=prctile(params(:,7,:),97.5,3)-mean(params(:,7,:),3);
errorbar(mean(params(:,3,:),3)*scale,mean(params(:,7,:),3)*scale,low*scale,high*scale,'k.')

low=mean(params(:,3,:),3)-prctile(params(:,3,:),2.5,3);
high=prctile(params(:,3,:),97.5,3)-mean(params(:,3,:),3);
herrorbar(mean(params(:,3,:),3)*scale,mean(params(:,7,:),3)*scale,low*scale,high*scale,'k.')

%plot(params(:,3)*scale,params(:,7)*scale,'k.')
xlim([max([min([params(:,3)-shift*4])*scale 0]) max(params(:,3)+shift*4)*scale])
...
bar((1:length(stimtype))*scale/10,(sort(mean(params(:,7,:),3)))*scale)
low=mean(params(:,7,:),3)-prctile(params(:,7,:),2.5,3);
high=prctile(params(:,7,:),97.5,3)-mean(params(:,7,:),3);
errorbar((1:length(stimtype))*scale/10,(sort(mean(params(:,7,:),3)))*scale,sort(low*scale),sort(high*scale),'k.')
...
low=mean(params(:,1,:),3)-prctile(params(:,1,:),2.5,3);
high=prctile(params(:,1,:),97.5,3)-mean(params(:,1,:),3);
errorbar(mu_rtDifs,mean(params(:,1,:),3),low,high,'k.')
xlabel('RT Dif')
ylabel('P-Whole')
hold off
...
low=mean(params(:,2,:),3)-prctile(params(:,2,:),2.5,3);
high=prctile(params(:,2,:),97.5,3)-mean(params(:,2,:),3);
errorbar(mu_rtDifs,mean(params(:,2,:),3),low,high,'k.')
xlabel('RT Dif')
ylabel('P-Part')
...
low=mean(params(:,3,:),3)-prctile(params(:,3,:),2.5,3);
high=prctile(params(:,3,:),97.5,3)-mean(params(:,3,:),3);
errorbar(mu_rtDifs,mean(params(:,3,:),3),low,high,'k.')
xlabel('RT Dif')
ylabel('P-Color')
...
low=mean(params(:,7,:),3)-prctile(params(:,7,:),2.5,3);
high=prctile(params(:,7,:),97.5,3)-mean(params(:,7,:),3);
errorbar(mu_rtDifs,mean(params(:,7,:),3),low,high,'k.')
