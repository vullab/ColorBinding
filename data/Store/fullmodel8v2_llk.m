function [resid full_llk]=fullmodel8v2_llk(params,data)
% v3-Original model
...
% v8v2-Model is having trouble converging for across, trying separate p
% parameters
p_whole=params(1);
p_partA=params(2);
p_partB=params(3);
...
if (p_colorA+p_colorB)<=1 && sum(params<0)==0 
