...
while version=="" or version==None:
    ...
    if version == '-1':  #crosses
        ...
        gensettings['bars-or-spot'] = 1
        fliplabels = True
    elif version == '14':# Faces
        offset1 = 8 # Width
        offset2 =10 # Height
        offset= offset1
        barsize = (0.2, 0.4)
        spotsize = (.25)
        gensettings['bars-or-spot'] = 6
    elif version == '15':# Inv Faces
        offset1 = 8 # Width
        offset2 =10 # Height
        offset= offset1
        barsize = (0.2, 0.4)
        spotsize = (.25)
        gensettings['bars-or-spot'] = 7
    else:
        version = ""
...
def oneTrial(trialdata):
    ...
    for i in range(0,int(trialdata['nitems'])):
        ...
        elif trialdata['bars-or-spot']==6:
        	drawer.drawFace([x,y], colors[horzcol[i]], colors[vertcol[i]], barsize,spotsize,offset1,offset2)
        elif trialdata['bars-or-spot']==7:
        	drawer.drawInvFace([x,y], colors[horzcol[i]], colors[vertcol[i]], barsize,spotsize,offset1,offset2)
...
def showColorOptions(colororder,idx1,centerVert,version,spotsize,offset,version2):
    ...
    if centerVert:
    	if version==2:
        	...
        	drawer.drawFaceOptions2(newcol, 1, barsize, spotsize,True,offset1,offset2)
        	drawer.drawFaceOptions2(newcol, 0, barsize, spotsize,False,offset1,offset2)
        elif version==7:
        	drawer.drawInvFaceOptions2(newcol, 1, barsize, spotsize,True,offset1,offset2)
        	drawer.drawInvFaceOptions2(newcol, 0, barsize, spotsize,False,offset1,offset2)
        elif version==0:
        	if version2=='6' or version2=='11': # WHY DID CORY MAKE THIS A STRING????
    	...
    	if version==2:
        	...
        	drawer.drawFaceOptions2(newcol, 0, barsize, spotsize,True,offset1,offset2)
        	drawer.drawFaceOptions2(newcol, 1, barsize, spotsize,False,offset1,offset2)
        elif version==7:
        	drawer.drawInvFaceOptions2(newcol, 0, barsize, spotsize,True,offset1,offset2)
        	drawer.drawInvFaceOptions2(newcol, 1, barsize, spotsize,False,offset1,offset2)
        elif version==0:

        	if version2=='6' or version2=='11':
    ...
    if version==2:
    	...
    	(posinds)=drawer.drawFaceGrid(newcol, barsize,spotsize,centerVert,offset1,offset2)
    elif version==7:
    	(posinds)=drawer.drawInvFaceGrid(newcol, barsize,spotsize,centerVert,offset1,offset2)
